    ...
    public class AccessMembershipProvider : MembershipProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Membership ASP.NET_Access_Providers2 Provider");
            }
                                                   ...
                                                   out    MembershipCreateStatus status)
        {
            ...
            if (userId != null)
            {
                throw new ArgumentException("userId Parameter must be null for ASP.NET_Access_Providers2");
            }
