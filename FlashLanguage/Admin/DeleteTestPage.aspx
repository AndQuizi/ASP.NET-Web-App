<%@ Page Title="Delete Test" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteTestPage.aspx.cs" Inherits="FlashLanguage2.Admin.DeleteTestPage" %>
     ...
     <div class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button ID="Button4" runat="server" OnClick ="DeleteTestBtn" OnClientClick="if(!confirm('Are you sure? Once a test is deleted, all student marks for that test will also be deleted.')) return false;"  Text="Delete Test" CssClass="btn btn-default" />
            </div>
        </div>
     </div>
